...
module.exports = async (req, res) => {
  if (req.method === 'GET') {
    ...
    return res.end(JSON.stringify({ ok:true, data:s }));
  }
  ...
  if (req.method === 'PUT' || req.method === 'POST') {
    ...
    req.on('end', async ()=>{
      try{
        ...
        await query(`update settings set initial_balance=$1,currency=$2,period_mode=$3,week_starts_on=$4,pin_enabled=$5 where id=$6`,
          [...values, curr.id]);
